...
parser.add_argument('--fmap', type=int, default=64, help='number of feature maps')
...
parser.add_argument('--test_datasize', type=int, default=500, help='dataset size to be tested')
parser.add_argument('--train_datasets_size', type=int, default=10000, help='datasets size for training')
