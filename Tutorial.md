...
1. Download the `.exe` file from [here](https://zenodo.org/record/6366812#.YjQFNupBybg). When you double click this self-extracting file, the relevant files of DeepCAD-RT will unzip to the location that you choose.
